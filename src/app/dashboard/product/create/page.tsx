...
export default function Page() {
    ...
    function displayEdit(option: any) {
        ...
        if (option.type == 2) {
            return <Option2 formik={formik} options={options} option={option} setOptions={setOptions} setOption2={setOption2} edit={true} isEditing={isEditing} setIsEditing={setIsEditing} editIndex={editIndex} setEditIndex={setEditIndex} />
        }
