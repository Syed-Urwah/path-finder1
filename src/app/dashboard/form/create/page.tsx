...
export default function NewPage() {
  ...
  const handleBlur = () => {
    setIsEditing(false); // Hide input field when input loses focus
  };
        ...
        >
          <div className="ml-3 flex gap-4 items-center w-full">
            ...
            {!isEditing ? (
              <div className="flex items-center">
                <span className="text-lg">{style.form_name}</span>
                <Pencil
                  className="font-bold h-5 w-5 ml-2 cursor-pointer"
          ...
          <div className="flex justify-end gap-4 items-center w-full h-full">
            ...
            <div className="flex gap-4 items-center h-full">
              ...
              <button
                    className="p-1.5 border-none rounded-full bg-gray-200 text-black cursor-pointer w-8 h-8 flex items-center justify-center"
                    data-state="closed"
                  >
                    <svg
                      aria-hidden="true"
                      ...
                      data-prefix="fas"
                      data-icon="gear"
                      className="w-4 h-4 text-current"  // Use "text-current" to inherit color
                      role="img"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512">
                      <path
