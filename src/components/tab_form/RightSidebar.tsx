...
export default function RightSidebar({activeTab ,setActiveTab, pages, setPages }: any) {
  ...
  const pageIndex: any = searchParams.get('page'); // Get the 'page' query parameter
  const questionIndex: any = searchParams.get('question'); // Get the 'question' query parameter

  console.log("page: " + pageIndex)
    console.log("question: " + questionIndex)

    function handleQuestionChange(e:any){
        const updatedValue = [...pages];
        const pagei = updatedValue[pageIndex]
        pagei.questions[questionIndex].name = e.target.value;
    ...
    useEffect(()=>{
        ...
        setPage(pageObject)
        const questionObject = pageObject?.questions[questionIndex ? questionIndex : 0]
    ...
    return (
        ...
        >
            <Tabs value={activeTab} defaultValue="account">
                    ...
                    /> */}
                        ...
                        <div className="flex flex-col gap-1 ">
                            ...
                            <div className="flex items-center gap-2">
                                <Input onChange={handleQuestionChange} value={question.name}/>
                                <DropdownMenu>
                                    <DropdownMenuTrigger>
                                        <div
