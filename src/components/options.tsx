      ...
      <div>
        ...
        >
          <div id="option1" className="flex items-center">
            <div
              id="option1"
              className="w-[16px] h-[16px] bg-black flex justify-center items-center border-1 border-black rounded-full"
            >
              <div className="w-[4px] h-[4px] bg-white rounded-full"></div>
            </div>
            <p id="option1" className="pl-[5px]">
          ...
          <p
            id="option1"
            className="w-[350px] max-w-[100%] whitespace-normal text-clip break-words text-gray-400"
          >
            Use multiple choice questions to let people make a choice.
          </p>
        </div>
        ...
        >
          <div id="option2" className="flex items-center">
            <div className="w-[16px] h-[16px] flex justify-center items-center bg-black text-white rounded text-[12px]">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
          ...
          <p
            ...
            className="w-[350px] max-w-[100%] whitespace-normal text-clip break-words text-gray-400"
          >
            Use multiple choice questions to let people make a selection of
            choices.
          </p>
        </div>
        ...
        >
          <div id="option3" className="flex items-center">
            <div className="w-[32px] h-[20px] flex justify-center items-center bg-black text-white rounded text-[10px]">
              1 2 3
            </div>
            <p id="option3" className="pl-[5px]">
              Number question
            </p>
          </div>
          ...
          <p
            ...
            className="w-[350px] max-w-[100%] whitespace-normal text-clip break-words text-gray-400"
          >
            Use number prompt to have people enter a number, such as square
            meters.
          </p>
        </div>
...
function Option1({
  ...
  function handleAnswerImageChange(e: any, index: number) {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        newAns[index] = { ...newAns[index], img: reader.result };
        setAns(newAns);
        console.log("Updated ans array:", newAns);
      };
  ...
  const handleFinished = () => {
    ...
    console.log("Is ans an array?", Array.isArray(ans));
...
function Option4({
  ...
  function handleAnswerChange(e: any, index: number): any {
    ...
    const selectedProduct: any = products.find(
      (product: any) => product.product_name == e
    );
  ...
  function addAnswerField() {
    // Check if the last answer is not empty
    if (
      ans[ans.length - 1].product_name !== "" &&
      ans[ans.length - 1].product_id !== null
    ) {
        ...
        <div className="space-y-2">
          {ans.map((ans: any, index: any) => (
            <div key={index}>
              ...
              <Select
                onValueChange={(e) => handleAnswerChange(e, index)}
                defaultValue={ans.product_name}
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    {products.map((product: any, key: any) => {
                      return (
                        <SelectItem key={key} value={product.product_name}>
