          ...
          <div className="grid grid-cols-12 gap-4">
              ...
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#D8BFD8] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" className="svg-inline--fa fa-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20px" height="20px">
                      <path fill="#000000" d="M256 8C119.4 8 8 119.4 8 256s111.4 248 248 248 248-111.4 248-248S392.6 8 256 8zM256 464c-114.9 0-208-93.1-208-208S141.1 48 256 48s208 93.1 208 208-93.1 208-208 208z"></path>
                    </svg>
                  </div>
                </div>
              ...
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#BCE4A8E5] flex justify-center items-center">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user" className="w-[24px] h-[24px] text-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              ...
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#FFA500] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="building" className="svg-inline--fa fa-building text-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="20px" height="20px">
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#D8BFD8] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="check" className="svg-inline--fa fa-check text-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20px" height="20px">
              ...
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#BCE4A8E5] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="at" className="svg-inline--fa fa-at" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ width: '24px', height: '24px' }}>
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#FFA500] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="address-card" className="svg-inline--fa fa-address-card text-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="20px" height="20px">
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#BCE4A8E5] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone" className="svg-inline--fa fa-phone" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ width: '20px', height: '20px' }}>
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#FFA500] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="briefcase" className="svg-inline--fa fa-briefcase text-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20px" height="20px">
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#D8BFD8] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="palette" className="svg-inline--fa fa-palette" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20px" height="20px">
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden undefined"><div className="w-full h-full bg-[#BCE4A8E5] flex justify-center items-center flex-col">
                  <div className="w-full h-full bg-[#C6CEFF] flex justify-center items-center flex-col"><div className="w-[10px] h-[3px] bg-black rounded-full mb-[3px]"></div><div className="w-[16px] h-[3px] bg-black rounded-full mb-[3px]"></div><div className="w-[10px] h-[3px] bg-black rounded-full mb-[3px]"></div><div className="w-[16px] h-[3px] bg-black rounded-full"></div></div>
                </div>
                </div>
              ...
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#F8BBD0] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="road" className="svg-inline--fa fa-road" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{ width: '24px', height: '24px' }}>
              ...
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#2E8B57] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="calendar-days" className="svg-inline--fa fa-calendar-days text-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20px" height="20px">
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden undefined"><div className="w-full h-full bg-[#BCE4A8E5] flex justify-center items-center flex-col">
                  <div className="w-full h-full bg-[#C6CEFF] flex justify-center items-center flex-col"><div className="w-[10px] h-[3px] bg-black rounded-full mb-[3px]"></div><div className="w-[16px] h-[3px] bg-black rounded-full"></div></div>
                </div>
                </div>
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#F8BBD0] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="location-dot" className="svg-inline--fa fa-location-dot" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style={{ width: '24px', height: '24px' }}>
            ...
            <div className="col-span-4">
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#F8BBD0] flex justify-center items-center flex-col">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="city" className="svg-inline--fa fa-city" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" style={{ width: '24px', height: '24px' }}>
                      <path fill="currentColor" d="M480 48c0-26.5-21.5-48-48-48H336c-26.5 0-48 21.5-48 48V96H224V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V96H112V24c0-13.3-10.7-24-24-24S64 10.7 64 24V96H48C21.5 96 0 117.5 0 144v96V464c0 26.5 21.5 48 48 48H304h32 96H592c26.5 0 48-21.5 48-48V240c0-26.5-21.5-48-48-48H480V48zm96 320v32c0 8.8-7.2 16-16 16H528c-8.8 0-16-7.2-16-16V368c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16zM240 416H208c-8.8 0-16-7.2-16-16V368c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16zM128 400c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V368c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32zM560 256c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H528c-8.8 0-16-7.2-16-16V272c0-8.8 7.2-16 16-16h32zM256 176v32c0 8.8-7.2 16-16 16H208c-8.8 0-16-7.2-16-16V176c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16zM112 160c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V176c0-8.8 7.2-16 16-16h32zM256 304c0 8.8-7.2 16-16 16H208c-8.8 0-16-7.2-16-16V272c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32zM112 320H80c-8.8 0-16-7.2-16-16V272c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16z"></path>
                    </svg>
                  </div>
                </div>
                <p>City</p>
              ...
              <button className="w-full flex gap-2 items-center hover:bg-[#0000000d] hover:p-[5px] hover:m-[-5px] rounded-[5px] cursor-pointer">
                <div className="w-[40px] h-[40px] rounded-[12px] flex justify-center items-center overflow-hidden">
                  <div className="w-full h-full bg-[#FFA500] flex justify-center items-center">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="paperclip" className="w-[24px] h-[24px] text-black" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
