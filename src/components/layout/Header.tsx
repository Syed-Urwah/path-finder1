        ...
        <div id="right" className="flex items-center gap-6">
          <div id="search" className="flex relative">
            ...
            <Input
              ...
              className="pl-10 rounded-3xl outline-[#d7dee1] "
            />
          </div>
          <Moon />
            ...
            <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
              ...
              >
                <DropdownMenuLabel className="text-xl flex gap-4">
                  <h2>Messages</h2>
                  <span className="bg-[#167eb5] rounded-xl text-white text-xs px-2 py-1 text-center m-auto">
                    5 new
                  </span>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
