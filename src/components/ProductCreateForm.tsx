...
export default function ProductCreateForm({product}: any) {
    ...
    const [mainImage, setMainImage] = useState(isEdit ? product.mediaUrl + '/' + product.image :  null)
    ...
    function displayEdit(option: any) {
        ...
        if (option.type == 1) {
            return <Option1 formik={formik} options={options} option={option} setOptions={setOptions} setOption1={setOption1} edit={true} isEditing={isEditing} setIsEditing={setIsEditing} editIndex={editIndex} setEditIndex={setEditIndex} isEditPage={isEdit} />
        }

        if (option.type == 2) {
            return <Option2 formik={formik} options={options} option={option} setOptions={setOptions} setOption2={setOption2} edit={true} isEditing={isEditing} setIsEditing={setIsEditing} editIndex={editIndex} setEditIndex={setEditIndex} isEditPage={isEdit} />
        }

        if (option.type == 3) {
            return <Option3 formik={formik} options={options} option={option} setOptions={setOptions} setOption3={setOption3} edit={true} isEditing={isEditing} setIsEditing={setIsEditing} editIndex={editIndex} setEditIndex={setEditIndex} />
        }
        if (option.type == 4) {
            return <Option4 formik={formik} options={options} option={option} setOptions={setOptions} setOption4={setOption4} edit={true} isEditing={isEditing} setIsEditing={setIsEditing} editIndex={editIndex} setEditIndex={setEditIndex} />
        }
    ...
    return (
        <div className="flex justify-center items-start min-h-screen bg-gray-100 p-4">
                                                        ...
                                                        if (!isLast) {
                                                            if (option.type == '4') {
                                                                if(isEdit && !answer.product_name){
                                                                    answer.product_name = answer.product?.product_name
                                                                }
            ...
            <div id="product_form" className="w-[500px] h-[800px]  mx-4 flex flex-col  ">
...
function DisplayOptions({ option, isEdit }: any): any {
                            ...
                            <div className="mt-4">
                                ...
                                <RadioGroup defaultValue="option-one">
                                    {option.answers.map((answer: any, index: any) => {
                                        ...
                                        if (!isLast) {
                                            return <div className="flex justify-between items-center space-x-2">
                                                <Label className="font-sans font-normal text-base" htmlFor="option-one">{answer.product_name}</Label>
                                                <div className="flex items-center gap-2">
                                                {/* {answer.img &&
                                                    <div className=" h-full">
